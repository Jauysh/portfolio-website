          ...
          <div className="space-y-24">
            {projects.map((project, idx) => (
              <motion.article 
                ...
                className="scroll-mt-32 border-t border-white/10 pt-16 relative group"
              >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-8 lg:gap-16">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="font-mono text-sm text-slate-gray/60 uppercase tracking-wide">
                  ...
                  <div className="prose prose-invert prose-slate max-w-none space-y-8">
                    <div>
                      ...
                      <p className="text-lg text-slate-gray/90 leading-relaxed">
                    ...
                    <div className="grid sm:grid-cols-2 gap-8 pt-6 border-t border-white/5">
                      <div>
                        <h3 className="text-xs font-mono tracking-widest text-amber/60 uppercase mb-3 flex items-center gap-2">
                      ...
                      <div>
                        <h3 className="text-xs font-mono tracking-widest text-emerald-400/60 uppercase mb-3 flex items-center gap-2">
                    ...
                    <div className="pt-6 border-t border-white/5 bg-white/[0.02] p-6 rounded-xl border border-white/5">
                      <h3 className="text-xs font-mono tracking-widest text-blue-400/60 uppercase mb-3 flex items-center gap-2">
